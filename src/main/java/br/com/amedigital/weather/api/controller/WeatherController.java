...
public class WeatherController {
    ...
    public Flux<WeatherResponse> findWeatherToCityInWeek(@PathVariable String cityCode) {
        return weatherService.findWeatherToCityInWeek(Integer.parseInt(cityCode))
                .doOnTerminate(() -> LOG.info("=== Finish finding weather to city ==="));
    }
}
